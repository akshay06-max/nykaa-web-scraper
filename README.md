...
## Task Overview
This project fulfills **Task-05 (Web Scraping)**. It is a robust Python automation tool designed to extract product names, prices, and customer ratings from Nykaa's e-commerce platform based on user search queries.
